...
try {
	...
	if (Schema::hasTable('posts')) {
		...
		DBIndex::dropIndexIfExists('posts', 'active');
	...
	if (Schema::hasTable('salary_types')) {
		if (Schema::hasColumn('salary_types', 'active')) {
			...
			DBIndex::dropIndexIfExists('salary_types', 'active');
			DBIndex::createIndexIfNotExists('salary_types', 'active');
		}
	}
	...
	$allData = [
		[
			...
			'method'    => 'getLocations',
			'options'   => '{"max_items":null,"enable_map":"1","map_background_color":null,"map_border":null,"map_hover_border":null,"map_border_width":null,"map_color":null,"map_hover":null,"map_width":null,"map_height":null,"cache_expiration":null}',
