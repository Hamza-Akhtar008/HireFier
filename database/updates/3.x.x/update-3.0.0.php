...
try {
	...
	// settings
	DB::table('settings')->where('key', 'guests_can_contact_seller')->delete();
	
	DB::table('settings')->where('key', 'guests_can_apply_jobs')->update([
		...
		'active'      => 1,
		'created_at'  => null,
		'updated_at'  => '2017-11-14 07:07:25',
	]);
	
	DB::table('settings')->whereIn('key', ['tiktok_url', 'linkedin_url', 'pinterest_url'])->delete();
