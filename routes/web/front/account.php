...
use App\Http\Controllers\Web\Front\Account\CompanyController as AccountCompanyController;
...
use App\Http\Controllers\Web\Front\Account\ResumeController as AccountResumeController;
...
$accountMiddlewares = ['auth', 'banned.user', 'no.http.cache'];
