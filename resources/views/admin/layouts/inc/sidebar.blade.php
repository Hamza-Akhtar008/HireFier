			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					@if (
						...
						|| doesUserHavePermission($authUser, 'company-list')
						|| doesUserHavePermission($authUser, 'post-type-list')
						|| doesUserHavePermission($authUser, 'salary-type-list')
						...
						<li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
								...
								@endif
								@if (doesUserHavePermission($authUser, 'company-list') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
										<a href="{{ urlGen()->adminUrl('companies') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
											<span class="hide-menu">{{ trans('admin.companies') }}</span>
										</a>
									</li>
								@endif
								@if (doesUserHavePermission($authUser, 'post-type-list') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
										<a href="{{ urlGen()->adminUrl('post_types') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
											<span class="hide-menu">{{ trans('admin.ad types') }}</span>
										</a>
									</li>
								@endif
								@if (doesUserHavePermission($authUser, 'salary-type-list') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
										<a href="{{ urlGen()->adminUrl('salary_types') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
					...
					@if (doesUserHavePermission($authUser, 'payment-list') || userHasSuperAdminPermissions())
						<li class="sidebar-item">
							<a href="#" class="sidebar-link has-arrow waves-effect waves-dark">
