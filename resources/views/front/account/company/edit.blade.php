					...
					<div class="inner-box">
						...
						@if (isMultipleCompaniesPerUserEnabled())
							<div class="mb-3" style="float: right; padding-right: 5px;">
								<a href="{{ url(urlGen()->getAccountBasePath() . '/companies') }}">{{ t('my_companies') }}</a>
							</div>
						...
						<div id="accordion" class="panel-group">
							...
							<div class="card card-default">
								<div class="card-header">
									<h4 class="card-title">
										<a href="#companyPanel" data-bs-toggle="collapse" data-parent="#accordion">
								...
								<div class="panel-collapse collapse show" id="companyPanel">
									<div class="card-body">
										<form name="company"
											  ...
											  role="form"
											  method="POST"
											  action="{{ url(urlGen()->getAccountBasePath() . '/companies/' . data_get($company, 'id')) }}"
										...
										>
											...
											@include('front.account.company._form')
