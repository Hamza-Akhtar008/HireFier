...
class UrlGen
{
	 ...
	 * @return string
	 */
	public function postPathBasic($id, string $slug = 'job-slug'): string
	{
	 ...
	 * @return string
	 */
	public function addPostCompany(): string
	{
		$url = isSingleStepFormEnabled()
			? url('create')
			: url('posts/create');
	 ...
	 * @return string
	 */
	public function addPostDetails(): string
	{
		$url = isSingleStepFormEnabled()
			? url('create')
			: url('posts/create/details');
	 ...
	 * @return string
	 */
	public function editPostCompany($entry): string
	{
		$entityId = isStringableStrict($entry) ? $entry : data_get($entry, 'id');
