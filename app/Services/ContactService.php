...
class ContactService extends BaseService
{
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function sendPostByEmail($postId, SendPostByEmailRequest $request): JsonResponse
	{
		// Get Post
		$post = Post::find($postId);
		...
		if (empty($mailData['recipient_email'])) {
			$message = 'The "recipient_email" field is not filled.';
