...
class ListingFormSetting
{
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			$value['multi_companies_per_user'] = '0';
			...
			if (!array_key_exists('multi_companies_per_user', $value)) {
				$value['multi_companies_per_user'] = '0';
			}
	...
	public static function getFields($diskName): array
	{
		...
		$fields = [
			...
			[
				'name'    => 'multi_companies_per_user',
				'label'   => trans('admin.multi_companies_per_user_label'),
				'type'    => 'checkbox_switch',
				'hint'    => trans('admin.multi_companies_per_user_hint'),
				'wrapper' => [
					'class' => 'col-md-6',
				],
			],
