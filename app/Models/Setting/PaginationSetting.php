		...
		$fields = array_merge($fields, [
			...
			[
				...
				'value' => trans('admin.pagination_limit_info', [
					...
					'citiesUrl'       => urlGen()->adminUrl('sections/find/getLocations'),
					'categoriesUrl'   => urlGen()->adminUrl('sections/find/getCategories'),
					'postsUrl'        => urlGen()->adminUrl('sections/find/getLatestListings'),
					'premiumPostsUrl' => urlGen()->adminUrl('sections/find/getPremiumListings'),
					'companiesUrl'    => urlGen()->adminUrl('sections/find/getCompanies'),
				]),
			],
			[
