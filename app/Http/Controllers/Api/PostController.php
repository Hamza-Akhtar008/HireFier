...
class PostController extends BaseController
{
	 ...
	 * @queryParam embed string Comma-separated list of the listing relationships for Eager Loading - Possible values: user,category,parent,postType,city,currency,savedByLoggedUser,pictures,payment,package.Example: user,postType
