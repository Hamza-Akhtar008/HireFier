...
class SectionController extends PanelController
{
	...
	public function resetAll($action): RedirectResponse
	{
		...
		if ($action == 'reorder') {
			...
			Section::where('key', 'premium_listings')->update(['lft' => 2, 'rgt' => 3, 'active' => 1]);
			Section::where('key', 'latest_listings')->update(['lft' => 4, 'rgt' => 5, 'active' => 1]);
			Section::where('key', 'categories')->update(['lft' => 6, 'rgt' => 7, 'active' => 1]);
			Section::where('key', 'locations')->update(['lft' => 8, 'rgt' => 9, 'active' => 1]);
			Section::where('key', 'companies')->update(['lft' => 10, 'rgt' => 11, 'active' => 1]);
			Section::where('key', 'stats')->update(['lft' => 12, 'rgt' => 13, 'active' => 1]);
			Section::where('key', 'text_area')->update(['lft' => 14, 'rgt' => 15, 'active' => 0]);
			Section::where('key', 'top_ad')->update(['lft' => 16, 'rgt' => 17, 'active' => 0]);
			Section::where('key', 'bottom_ad')->update(['lft' => 18, 'rgt' => 19, 'active' => 0]);
		...
		if ($action == 'options') {
			...
			Section::where('key', 'companies')->update(['value' => null, 'active' => 1]);
