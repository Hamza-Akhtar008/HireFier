...
use App\Http\Controllers\Web\Front\Post\Show\Traits\UserResumes;
...
{
	use CatBreadcrumb, UserResumes, SimilarPosts;
	 ...
	 */
	public function __construct(PostService $postService, ResumeService $resumeService)
	{
		parent::__construct();
